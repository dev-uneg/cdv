...
<section class="py-16 bg-white">
  <div class="max-w-[1300px] mx-auto px-6 grid gap-10 lg:grid-cols-[1.4fr,0.6fr]">
    ...
    <div class="flex flex-col gap-4">
      ...
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-300 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-700" href="<?= $baseUrl ?>/PDFs/preparatoria/Colegio-Del-Valle-Requisitos-Preparatoria-2023.pdf" target="_blank" rel="noopener">
...
<section class="py-16 bg-white">
  <div class="max-w-[1300px] mx-auto px-6 text-center">
    ...
    <div class="mt-6 grid gap-4 md:grid-cols-4">
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-300 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-700" href="<?= $baseUrl ?>/PDFs/preparatoria/REGLAMENTO-OFICIAL-PREPA.pdf" target="_blank" rel="noopener">
      ...
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-300 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-700" href="<?= $baseUrl ?>/PDFs/preparatoria/Colegio-Del-Valle-Preparatoria-Aviso-de-Privacidad.pdf" target="_blank" rel="noopener">
