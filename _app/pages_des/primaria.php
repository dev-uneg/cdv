...
$heroTitle = 'PRIMARIA';
$heroDescription = 'Formacion academica integral con bases solidas, pensamiento critico y acompanamiento cercano.';
$heroIcon = 'book-check';
$enableAos = true;
$heroYoutubeEmbed = 'https://www.youtube-nocookie.com/embed/_8ykrGpyyOM?autoplay=1&rel=0';
$heroVideoTitle = 'Primaria - Colegio del Valle';
...
<section class="pt-0 pb-0 bg-white" data-aos="fade-up">
  <div class="w-full mx-auto px-0">
    <div class="h-[480px] w-full overflow-hidden rounded-none border border-slate-200 bg-white">
      <iframe
        class="h-full w-full"
        src="https://www.youtube-nocookie.com/embed/_8ykrGpyyOM?rel=0"
...
<section class="py-16 bg-white" data-aos="fade-up">
  <div class="max-w-[1300px] mx-auto px-6 grid gap-10 lg:grid-cols-2 items-start lg:items-center">
    <div class="text-center lg:text-left">
      <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#345995]">RVOE SEP 09050086/06/2005</p>
...
<section class="py-16 bg-white" data-aos="fade-up">
  <div class="max-w-[1300px] mx-auto px-6 text-center">
    ...
    <p class="mt-4 text-[#345995]">Para poder cursar alguno de los grados de primaria en Colegio Del Valle se requiere cumplir</p>
...
<section class="py-16 bg-white" data-aos="fade-up">
  <div class="max-w-[1300px] mx-auto px-6">
    <div class="grid gap-6 md:grid-cols-3">
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] transition border-[#345995] bg-[#345995] text-white hover:brightness-110" href="<?= $baseUrl ?>/_assets/PDFs/primaria/REGLAMENTO-PRIMARIA-2025-2026.pdf" target="_blank" rel="noopener">
        <i class="text-base" data-lucide="file-text"></i>
        Reglamento
      </a>
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] transition border-[#03CEA4] bg-[#03CEA4] text-slate-900 hover:brightness-105" href="<?= $baseUrl ?>/_imgs/primaria/Calendario-primaria.webp" target="_blank" rel="noopener">
    ...
    <h2 class="mt-10 text-4xl md:text-5xl font-semibold text-[#345995] text-center">Preguntas frecuentes</h2>
