...
try {
    ...
    $countStmt = $pdo->prepare('SELECT COUNT(*) FROM egresados_registros' . $whereSql);
    ...
    $stmt = $pdo->prepare('SELECT * FROM egresados_registros' . $whereSql . ' ORDER BY created_at DESC LIMIT :limit OFFSET :offset');
    ...
    $dbError = 'No se pudo cargar la tabla de egresados. Revisa la configuración de BD.';
}
