...
try {
    ...
    $countStmt = $pdo->prepare('SELECT COUNT(*) FROM contacto_leads' . $whereSql);
    ...
    $stmt = $pdo->prepare('SELECT * FROM contacto_leads' . $whereSql . ' ORDER BY created_at DESC LIMIT :limit OFFSET :offset');
    ...
    $dbError = 'No se pudo cargar la tabla de contacto. Revisa la configuración de BD.';
}

ob_start();
require __DIR__ . '/../../pages/admin/contacto.php';
