...
<head>
  ...
  <title><?php echo htmlspecialchars((string) ($pageTitle ?? 'Admin CDV'), ENT_QUOTES, 'UTF-8'); ?></title>
  <link rel="stylesheet" href="<?php echo htmlspecialchars((string) $base, ENT_QUOTES, 'UTF-8'); ?>/_assets/output.css">
  <link rel="stylesheet" href="<?php echo htmlspecialchars((string) $base, ENT_QUOTES, 'UTF-8'); ?>/_assets/admin-fonts.css">
  <script defer src="<?php echo htmlspecialchars((string) $base, ENT_QUOTES, 'UTF-8'); ?>/_assets/lucide-loader.js?v=5" data-lucide-sprite="<?php echo htmlspecialchars((string) $base, ENT_QUOTES, 'UTF-8'); ?>/_assets/lucide-sprite.svg?v=20260409"></script>
  ...
  <script>
    (function () {
      ...
      const upgradeLucideIcons = (scope) => {
        const spriteHref = '<?php echo htmlspecialchars((string) $base, ENT_QUOTES, 'UTF-8'); ?>/_assets/lucide-sprite.svg?v=20260409';
