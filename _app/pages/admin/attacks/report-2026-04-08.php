  ...
  <main class="mx-auto w-full max-w-7xl px-4 py-10">
    <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p class="inline-flex items-center gap-2 rounded-full bg-sky-100 px-3 py-1 text-xs font-semibold text-sky-800">
            <i data-lucide="shield-check" class="h-3.5 w-3.5"></i>
            Reporte Estatico · Seguridad Informatica
          </p>
          <h1 class="mt-3 text-3xl font-semibold text-slate-900">Revision General de Endpoints (Bootstrap)</h1>
          <p class="mt-2 text-sm text-slate-600">Fecha: 08 de abril de 2026.</p>
          <p class="mt-1 text-sm text-slate-600">Documento estatico para lectura ejecutiva: no consulta BD ni reemplaza pruebas de seguridad activas.</p>
        </div>
