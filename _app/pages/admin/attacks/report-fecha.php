...
<body class="min-h-screen bg-slate-50 text-slate-900">
  ...
  <main class="w-full px-4 py-10 lg:pl-[17rem] lg:pr-6">
    <?php
      ...
      $headerBadgeText = 'Seguridad · Reportes Estáticos';
      $headerBadgeClass = 'bg-rose-100 text-rose-800';
      $headerTitleIcon = 'file-warning';
      $headerTitleIconClass = 'h-7 w-7 text-rose-700';
      $headerTitle = 'Reportes de Ataques';
      $headerSubtitleHtml = 'Listado de reportes guardados en <code>_app/pages/admin/attacks</code>.';
      $headerActionsHtml = '<a href="' . htmlspecialchars($base, ENT_QUOTES, 'UTF-8') . '/admin/panel" class="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100"><i data-lucide="layout-dashboard" class="h-4 w-4"></i>Panel</a>';
