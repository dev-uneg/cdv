...
<head>
  ...
  <title>Detalle Buzón | Admin CDV</title>
...
<body class="min-h-screen bg-slate-50 text-slate-900">
  ...
  <main class="w-full px-4 py-10 lg:pl-[17rem] lg:pr-6">
    <?php
      ...
      $headerTitle = 'Detalle de Buzón';
      $headerSubtitle = 'Consulta completa del mensaje institucional.';
      $headerActionsHtml = '<a class="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100" href="' . htmlspecialchars($base, ENT_QUOTES, 'UTF-8') . '/admin/buzon-rector"><i data-lucide="arrow-left" class="h-4 w-4"></i>Volver</a>';
