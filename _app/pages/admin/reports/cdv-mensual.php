...
<head>
  ...
  <title>Reporte CDV | <?php echo htmlspecialchars($monthLabel, ENT_QUOTES, 'UTF-8'); ?></title>
  ...
  <main class="mx-auto w-full max-w-7xl px-4 py-10">
    ...
    <section class="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div class="border-b border-slate-200 px-5 py-4">
        <h2 class="text-xl font-semibold text-slate-800">Salud técnica (PageSpeed)</h2>
      </div>
      <?php if (is_array($pageSpeedSnapshot)): ?>
        <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-5 py-4">
          ...
          <div class="flex flex-wrap items-center gap-2">
            <a href="<?php echo htmlspecialchars((string) ($pageSpeedSnapshot['evidence_url'] ?? '#'), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-800 hover:bg-blue-100">Sustento PageSpeed</a>
        ...
        <div class="grid grid-cols-1 gap-5 p-5 xl:grid-cols-2">
          <?php foreach (($pageSpeedSnapshot['devices'] ?? []) as $device): ?>
                ...
                <?php foreach (($device['metrics'] ?? []) as $metric): ?>
                  ...
                  <div class="rounded-lg border border-slate-200 bg-white p-3">
                    <div class="flex items-center justify-between gap-2">
                      <p class="text-xs font-semibold text-slate-600"><?php echo htmlspecialchars((string) ($metric['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></p>
    ...
    <section class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Leads sin page_path o URL</p>
