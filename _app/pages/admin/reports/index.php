...
<head>
  ...
  <script defer src="<?php echo $base; ?>/_assets/lucide-loader.js?v=3" data-lucide-sprite="<?php echo $base; ?>/_assets/lucide-sprite.svg?v=20260409"></script>
  <style>
    @font-face {
      font-family: 'Figtree';
...
<body class="min-h-screen bg-slate-50 text-slate-900">
  ...
  <main class="w-full px-4 py-10 lg:pl-[17rem] lg:pr-6">
    <?php
      ...
      $headerSubtitle = 'Listado de reportes mensuales de performance web y CRO (CDV).';
      $headerActionsHtml = '<a href="' . htmlspecialchars($base, ENT_QUOTES, 'UTF-8') . '/admin/panel" class="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100"><i data-lucide="layout-grid" class="h-4 w-4"></i>Panel</a>';
