  ...
  <main class="w-full px-4 py-10 lg:pl-[17rem] lg:pr-6">
    ...
    <section class="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <dl class="grid gap-4 md:grid-cols-2">
        ...
        <div><dt class="text-xs uppercase tracking-wide text-slate-500">Año de ingreso</dt><dd class="mt-1 text-sm text-slate-800"><?php echo htmlspecialchars((string) ($row['anio_ingreso'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></dd></div>
        <div><dt class="text-xs uppercase tracking-wide text-slate-500">Año de egreso</dt><dd class="mt-1 text-sm text-slate-800"><?php echo htmlspecialchars((string) ($row['anio_egreso'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></dd></div>
        <div class="md:col-span-2"><dt class="text-xs uppercase tracking-wide text-slate-500">Carrera de egreso</dt><dd class="mt-1 text-sm text-slate-800"><?php echo htmlspecialchars((string) ($row['carrera_egreso'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></dd></div>
