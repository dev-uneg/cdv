        ...
        <table class="min-w-full whitespace-nowrap text-left text-sm">
          <thead class="bg-slate-100 text-slate-600">
            <tr>
              ...
              <th class="px-4 py-3 font-semibold">Trabaja</th>
          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <?php foreach ($rows as $row): ?>
              <?php $fullName = trim((string) (($row['nombre'] ?? '') . ' ' . ($row['apellido_paterno'] ?? '') . ' ' . ($row['apellido_materno'] ?? ''))); ?>
              <tr class="hover:bg-slate-50">
                ...
                <td class="px-4 py-3 font-medium text-slate-800"><?php echo htmlspecialchars($fullName, ENT_QUOTES, 'UTF-8'); ?></td>
                <td class="px-4 py-3 text-slate-600"><?php echo htmlspecialchars((string) ($row['email'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                <td class="px-4 py-3 text-slate-600"><?php echo htmlspecialchars((string) ($row['generacion'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                <td class="px-4 py-3 text-slate-600"><?php echo htmlspecialchars((string) ($row['nivel_egreso'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                <td class="px-4 py-3 text-slate-600">
                  <?php echo ((int) ($row['trabaja_actualmente'] ?? 0) === 1) ? 'Sí' : 'No'; ?>
                </td>
                <td class="px-4 py-3">
