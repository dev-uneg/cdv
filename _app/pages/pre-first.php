...
<section class="pt-0 pb-0 bg-white">
  <div class="w-full mx-auto px-0">
    <div class="h-[480px] w-full overflow-hidden rounded-none border border-slate-200 bg-white">
      <div class="relative h-full w-full" data-youtube-lite data-video-id="ChHNs6VYH5I" data-video-title="Pre-First - Colegio del Valle">
        <button class="relative block h-full w-full" type="button" data-youtube-play aria-label="Reproducir video de Pre-First">
          <img class="h-full w-full object-cover" src="https://i.ytimg.com/vi/ChHNs6VYH5I/hqdefault.jpg" alt="" aria-hidden="true" loading="lazy" />
  ...
  <div class="max-w-[1300px] mx-auto px-6 grid gap-10 lg:grid-cols-[0.9fr,1.1fr] items-start" data-tabscope data-default="modelo">
    ...
    <div class="min-h-[280px] rounded-3xl border border-slate-200 bg-white p-8">
      ...
      <div class="hidden" data-panel="horario">
        ...
        <p class="mt-2 text-slate-600">de 8:00 hrs a 14:00 hrs</p>
      </div>
