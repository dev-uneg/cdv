<?php
$pageTitle = 'Aviso de Privacidad | Colegio del Valle';
$pageDescription = 'Consulta el Aviso de Privacidad del Colegio del Valle para conocer el tratamiento de tus datos personales.';
$activePage = '';
...
<section class="bg-white py-16">
  <div class="mx-auto max-w-[980px] px-6">
    <h1 class="text-center text-3xl font-semibold text-slate-800 md:text-4xl">Aviso de Privacidad</h1>
    <p class="mt-4 text-center text-sm text-slate-500">Ultima actualizacion: 17 de marzo de 2026</p>

    <div class="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-10">
      <div class="space-y-8 text-slate-700">
        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <p class="text-sm leading-relaxed">
            Colegio del Valle, con domicilio en Mier y Pesado 227, Col. del Valle Centro, Benito Juarez, C.P. 03100, Ciudad de Mexico, es responsable del tratamiento de los datos personales que recaba de aspirantes, madres, padres, tutores, alumnado y personas usuarias del sitio web.
          </p>
        </div>
        ...
        <div>
          <h2 class="text-xl font-semibold text-slate-800">2. Finalidades del tratamiento</h2>
          <p class="mt-3 text-sm leading-relaxed">
          ...
          <p class="mt-3 text-sm leading-relaxed">
            De forma secundaria, y solo cuando aplique, podremos utilizar tus datos para fines estadisticos internos o mejora de nuestros servicios. Si no deseas que tus datos sean tratados para finalidades secundarias, puedes solicitarlo mediante los medios indicados en este aviso.
          </p>
        </div>
        ...
        <div>
          <h2 class="text-xl font-semibold text-slate-800">5. Uso de tecnologias de rastreo</h2>
          <p class="mt-3 text-sm leading-relaxed">
            El sitio puede utilizar cookies u otras tecnologias para fines de funcionamiento, analitica y mejora de experiencia. Puedes modificar la configuracion de tu navegador para limitar o bloquear estas tecnologias; sin embargo, algunas funciones podrian verse afectadas.
          </p>
        </div>
