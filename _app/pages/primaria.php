...
<section class="pt-0 pb-0 bg-white">
  <div class="w-full mx-auto px-0">
    <div class="h-[480px] w-full overflow-hidden rounded-none border border-slate-200 bg-white">
      <div class="relative h-full w-full" data-youtube-lite data-video-id="_8ykrGpyyOM" data-video-title="Primaria - Colegio del Valle">
        <button class="relative block h-full w-full" type="button" data-youtube-play aria-label="Reproducir video de Primaria">
          <img class="h-full w-full object-cover" src="https://i.ytimg.com/vi/_8ykrGpyyOM/hqdefault.jpg" alt="" aria-hidden="true" loading="lazy" />
...
<section class="py-16 bg-white">
  <div class="max-w-[1300px] mx-auto px-6">
    <div class="grid gap-6 md:grid-cols-3">
      <a class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-300 px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-700" href="<?= $baseUrl ?>/_assets/PDFs/primaria/REGLAMENTO-PRIMARIA-2025-2026.pdf" target="_blank" rel="noopener">
