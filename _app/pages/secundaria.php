...
<section class="pt-0 pb-0 bg-white">
  <div class="w-full mx-auto px-0">
    <div class="h-[480px] w-full overflow-hidden rounded-none border border-slate-200 bg-white">
      <div class="relative h-full w-full" data-youtube-lite data-video-id="r4e50DQsLmo" data-video-title="Secundaria - Colegio del Valle">
        <button class="relative block h-full w-full" type="button" data-youtube-play aria-label="Reproducir video de Secundaria">
          <img class="h-full w-full object-cover" src="https://i.ytimg.com/vi/r4e50DQsLmo/hqdefault.jpg" alt="" aria-hidden="true" loading="lazy" />
